...
summary: Licence, attribution, and what the numbers will and will not support.
group: trust
order: 2
status: published
updated: '2026-07-25'
...
Report content, figures, and written analysis are licensed under [Creative Commons Attribution 4.0 International](https://creativecommons.org/licenses/by/4.0/). You may copy, redistribute, adapt, and build on the material for any purpose, including commercially, provided you give attribution.
...
- [2023 report](/reports/2023)
- [2024 report](/reports/2024)
...
Tell us. Raise a GitHub issue on the public repository or use [/contribute](/contribute). Corrections take priority over new content, and the [data safety rules](/docs/data-safety) describe how a fix lands.
