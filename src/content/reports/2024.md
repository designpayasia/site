...
- id: 'closing'
  ...
  summary: 'Where the 2024 findings leave the region, and the questions they raise.'
  body: |-
    Across eight sections, 32 questions surfaced from the data — questions that designers, team leads, and organisations across Southeast Asia are all asking. They are not rhetorical. They are the real tensions the numbers expose, and they deserve more than a single report can answer.

    The data describes a young, mobile, and increasingly self-aware design workforce still negotiating — market by market — what its worth should be. It confirms that digital product design has matured as a profession in the region. It also confirms that career paths, pay structures, and leadership pipelines have not kept pace.

    The questions below are pulled from each section of the report. They are organised around the two audiences this report speaks to: the designer building a career, and the leader building an organisation. Some questions overlap. That is the point — the answers will need to come from both sides.

    So we will leave you with the question the year keeps asking: where do you sit in this data, and does it match how you feel about the value of your work?
  whatThisMeansIndividuals: |-
    How can we better capture design industry data from underrepresented Southeast Asian markets, particularly around language and accessibility barriers?
    What impact will distributed teams and remote work have on traditional design hubs like Singapore and Jakarta?
    How is the concentration of young designers (80% under 35) shaping workplace culture and expectations across different markets?
    How will more open discussions about pay affect the previous salary plus 20 percent practice?
    What should companies do to make pay talks easier for everyone?
    How can we respect cultural differences while ensuring fair pay?
    Will design teams grow larger like they have in Western countries?
    ...
    How can Southeast Asian designers help others see design as strategic work?
    Should proving the value of design be someone's specific job rather than everyone's extra work?
    How will AI change what designers do day-to-day?
    Will the design market in Southeast Asia follow similar patterns to the US tech recovery?
    How can the industry better balance new graduates and existing talent with market demand?
    How might cross-border work opportunities change in Southeast Asia?
  whatThisMeansLeaders: |-
    Why are we not seeing more design leaders in our region?
    How important are university degrees in different companies and countries?
    How will budget cuts affect developing future design leaders and career pathways?
    Will we keep paying managers much more, or will we create better-paid roles for senior designers?
    How does basing new job offers on previous salary (plus 20 percent) affect the industry long term?
    What happens when managers must both lead and do design work themselves?
    How can companies pay fairly across different countries when teams work remotely?
    Who should make sure hybrid work actually works — design teams or someone else?
    Will budget cuts make pay differences bigger or smaller?
    ...
    What new design specialties might emerge as technology and business needs evolve?
  questions:
    - 'If every designer in this report advocated for pay transparency tomorrow, what would change?'
    - 'In five years, will Southeast Asia have a design leadership bench that reflects the size and ambition of its design workforce?'
    - 'What is the one number or story from this report you will take back to your team?'
