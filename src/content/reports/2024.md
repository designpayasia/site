...
- id: 'methodology'
  ...
  body: |-
    - Conducted over eight weeks from October to November 2024 across Southeast Asia
    - Distributed through design communities, social media channels, professional networks, and direct outreach to design leaders
    - 1,797 valid responses collected after data cleaning, which removed incomplete submissions, duplicate entries, and responses failing consistency checks
    - Survey covered compensation (salary, bonuses, equity), demographics, career history, negotiation behaviour, work preferences, and perceptions of design's organisational value
    - Sample skews toward Indonesia (79.0% of respondents), which may over-represent Indonesian market conditions in aggregate statistics
    - Voluntary participation introduces self-selection bias — designers with stronger opinions or more extreme compensation experiences may be over-represented
    - Despite limitations, this represents the most comprehensive view of design compensation and careers in Southeast Asia available to date
...
- id: 'closing'
  ...
  summary: 'Where the 2024 findings leave the region, and the question they raise.'
  body: |-
    The numbers here describe a young design workforce, mobile and increasingly conscious of its own worth, still negotiating market by market what that worth should be. They mark where Southeast Asia's designers stood in 2024. What comes next is not settled in these pages; that part belongs to the community the data describes.
