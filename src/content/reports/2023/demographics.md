...
The inaugural 2023 survey reached designers across 10 countries. Three markets formed the core: Singapore at 224 respondents (69.4%), Malaysia at 46 (14.2%), and Indonesia at 29 (8.9%). The Philippines contributed 8 respondents (2.5%), Vietnam 7 (2.2%), Thailand 3 (0.9%), and six others from Taiwan, India, Romania, and Japan. Singapore accounts for most responses. The Philippines, with eight designers, is a real part of the 2023 picture, but a cohort this small falls below our ten-response reporting floor, so we publish no median pay or rate figures for the Philippines on its own.
