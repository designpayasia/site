...
One market from 2023 is largely missing here: the Philippines. Last year eight designers there took part in the survey. This year, too few responded to clear our ten-response reporting floor, so the Philippines doesn't appear in the charts above. Our reach in the Philippines hasn't kept pace with the rest of the region, and closing that gap is on us. UXPH, one of the community partners we thank in this report, is well placed to help. We'd rather say plainly that the data isn't there yet than quietly drop a market we've counted before.
