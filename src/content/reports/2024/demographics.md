...
One market from 2023 is largely missing here: the Philippines. Eight designers took part last year; this year too few responded to clear our ten-response reporting floor, so the Philippines doesn't appear in the charts above. Our reach there hasn't grown alongside the rest of the region. Thanks to UXPH, one of this report's community partners. We'd rather say the data isn't there yet than quietly drop a market we've counted before.
