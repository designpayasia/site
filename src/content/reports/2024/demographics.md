...
One market from 2023 is largely missing here: the Philippines. Last year eight designers there took part in the survey. This year, too few responded to clear our ten-response reporting floor, so the Philippines doesn't appear in the charts above. That's a gap in our reach, not a sign that the community there has shrunk. UXPH, one of the community partners we thank in this report, is well placed to help us close it. We'd rather say plainly that the data isn't there yet than quietly drop a market we've counted before.
